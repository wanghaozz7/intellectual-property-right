<template>
  <div class="out-side-container">
    <el-container style="min-height: 500px;">
      <el-main style="padding: 0;min-height: 500px;">
      ...
      <el-aside width="350px" style="padding: 0;background-color: #fff;margin-bottom: 0;">
    ...
    <pagination style="padding-left: 200px;" v-show="ctotal > 0" :total="ctotal" :page.sync="cpage" :limit.sync="climit"
      @pagination="getList" :pageSizes=sizes />
  </div>
</template>

<script>
import Pagination from '@/components/Pagination/index.vue'
import AsideList from '@/components/ArticleList/asideList/index.vue'
export default {
  name: '',
  components: {
    Pagination,
