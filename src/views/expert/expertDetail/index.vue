      ...
      <div class="achievements">
        <div class="achievements-tag">
          ...
          <div class="back-white" style="padding-bottom: 10px">
            <el-tabs type="card" style="margin-left: 10px" v-model="tag_active" @tab-click="achievements_tag_handle">
                ...
                <div v-else class="paper">
                  <div class="paper-item" v-for="(data, i) in paperList" :key="i">
                    ...
                    <div class="paper-item-right">
                      ...
                      <div class="tag">
                        <el-tag :type="index % 3 == 0?'warning': index % 3 == 1? 'success': 'primary'" v-for="(k, index) in data.kws" :key="index">{{ k }} </el-tag>
                      </div>
                      <div class="detail">
                        <p>
                          摘要： {{ data.abs }}
        ...
        <div class="Experts-same-expertInfo flex">
          <div class="Experts-same-expertInfo-item back-white flex" v-for="(data, i) in sameDomains" :key="i">
            ...
            <div class="item-right">
              ...
              <el-tag type="warning" style="max-width: 200px;overflow: hidden;text-overflow: ellipsis;">{{ data.org }}</el-tag>
